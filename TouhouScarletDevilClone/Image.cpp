...
//TODO:
void Image::FrameRender(HDC hdc, int destX, int destY, int frameX, int frameY, int frameIndex, bool isFlip)
{
    int newDestX = destX - frameX / 2;
    int newDestY = destY - frameY / 2;

    int curFrameX = imageInfo->currFrameX;
    int curFrameY = imageInfo->currFrameY;
    // Render(hdc, newDestX, newDestY, frameIndex, isFlip);
